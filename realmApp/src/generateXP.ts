...
exports = async function (arg) {
   ...
   const accrualConfiguration: any = await configCollections.XP.findOne({ configType: "accrual" });
   const generationConfiguration: any = await configCollections.XP.findOne({ configType: "generation" });
